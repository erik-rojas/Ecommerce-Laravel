                                                ...
                                                <div class="form-group col-sm-4">							
                                                    ...
                                                    <div class="col-sm-12">								
                                                        ...
                                                        <select name="{{ $attributes_data['option']['id'] }}" onChange="getQuantity()" class="currentstock form-control attributeid_<?=$index++?>" attributeid = "{{ $attributes_data['option']['id'] }}">
                                                            ...
                                                            <option  attributes_value="{{ $values_data['products_attributes_id'] }}" value="{{ $values_data['id'] }}" prefix = '{{ $values_data['price_prefix'] }}'  value_price ="{{ $values_data['price']+0 }}"  @if(count($result['cart'][0]->attributes)>0) @if(in_array($values_data['id'], $cart_attribiters)) selected @endif @endif >{{ $values_data['value'] }}</option>								
                                                            @endforeach								
                                                        </select>								
                                                    </div>							
                                                </div>
                                        ...
                                        <div class="form-inline product-box">
                                            <div class="form-group Qty">	
                                                ...
                                                <div class="input-group">						
                                                    ...
                                                    <input type="text" readonly name="quantity" value="{{$result['cart'][0]->customers_basket_quantity}}" min="@if($result['detail']['product_data'][0]->products_min_order>0) {{$result['detail']['product_data'][0]->products_min_order}} @else 1 @endif" max="@if($result['detail']['product_data'][0]->products_max_stock>0){{ $result['detail']['product_data'][0]->products_max_stock}}@else{{ $result['detail']['product_data'][0]->defaultStock}}@endif" class="form-control qty">											
                                            ...
                                            <div class="price-box">
                                                ...
                                                <span class="total_price">
                                                    ...
                                                    @else
                                                        {{$web_setting[19]->value}}{{$result['detail']['product_data'][0]->products_price+0}}
                                                    @endif-->
                                                    {{$web_setting[19]->value}}{{$result['cart'][0]->final_price}}
                                                </span>				
                                            </div>
