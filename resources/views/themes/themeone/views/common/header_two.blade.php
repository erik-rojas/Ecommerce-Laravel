<header id="header-area" class="header-area bg-primary">
    ...
    <div class="header-maxi">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-12  col-sm-12 col-lg-5 spaceright-0">
                 ...
                 <div class="col-12 col-sm-8 col-md-9 col-lg-4 px-0">      
                ...
                <div class="col-12 col-sm-4 col-md-3 col-lg-3 spaceleft-0">
                    <ul class="top-right-list">        
                        <!--<li class="phone-header">
                            <a>
                                <img class="img-fluid" src="{{asset('').'images/phone.png'}}" alt="icon">
                                <span class="block">
                        ...
                        <li class="wishlist-header">
                            <a href="{{ URL::to('/wishlist')}}">
                                ...
                                <!--<img class="img-fluid" src="{{asset('').'images/wishlist_bag.png'}}" alt="icon">-->
