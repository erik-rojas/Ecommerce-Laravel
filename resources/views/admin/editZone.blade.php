...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    ...
    <ol class="breadcrumb">
      ...
      <li><a href="../listingZones"><i class="fa fa-dashboard"></i>{{ trans('labels.ListingAllZones') }}</a></li>
              	  ...
              	  <div class="box box-info"><br>
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            ...
                            {!! Form::open(array('url' =>'admin/updateZone', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            {!! Form::hidden('zone_id', $result['zones'][0]->zone_id, array('class'=>'form-control', 'id'=>'zone_name'))!!}
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
                                	<select name="zone_country_id" class='form-control field-validate'>
                                        ...
                                        <option
                                        	@if( $countries_data->countries_id == $result['zones'][0]->zone_country_id)
                                            	selected
                                            @endif
                            ...
                            <div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									{!! Form::text('zone_name', $result['zones'][0]->zone_name, array('class'=>'form-control field-validate', 'id'=>'zone_name'))!!}
							...
							<div class="form-group">
								...
								<div class="col-sm-10 col-md-4">
									{!! Form::text('zone_code', $result['zones'][0]->zone_code, array('class'=>'form-control field-validate', 'id'=>'zone_code'))!!}
