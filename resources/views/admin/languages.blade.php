        ...
        <div class="box">
          <div class="box-header">
            ...
            <div class="box-tools pull-right">
                <a href="{{ URL::to('admin/addlanguages')}}" type="button" style="display:inline-block; width: auto; margin-top: 0; -webkit-appearance: none;" class="btn btn-block btn-primary">{{ trans('labels.AddLanguage') }}</a>
            </div>
          </div>
