            ...
            <div class="row">
              <div class="col-12">
              		<div class="box box-info">
                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                            {!! Form::open(array('url' =>'admin/updatesuperadmin', 'method'=>'post', 'class' => 'form-horizontal form-validate', 'enctype'=>'multipart/form-data')) !!}
                            ...
                            <hr>
                              ...
                              <div class="box-footer text-center">
                                ...
                                <a href="{{ URL::to('admin/superadmins')}}" type="button" class="btn btn-default">{{ trans('labels.back') }}</a>
                              </div>
                              <!-- /.box-footer -->
                            {!! Form::close() !!}
                        </div>
