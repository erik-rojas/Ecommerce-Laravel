...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1> {{ trans('labels.superadmins') }} <small>{{ trans('labels.superadmins') }}...</small> </h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/dashboard/this_month')}}"><i class="fa fa-dashboard"></i> {{ trans('labels.breadcrumb_dashboard') }}</a></li>
      <li class="active">{{ trans('labels.superadmins') }}</li>
    </ol>
  </section>
							...
							<tr>
                              ...
                              <li class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="editsuperadmin/{{ $admin->myid }}">{{ trans('labels.editsuperadmin') }}</a></li>
