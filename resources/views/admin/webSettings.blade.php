                        ...
                        <!-- form start -->                        
                         <div class="box-body">
                          ...
                          @endif
                            ...
                            <div class="form-group">
                              ...
                              <select name="{{$result['settings'][81]->name}}" class="form-control">
                                ...
                                <option @if($result['settings'][81]->value == 'app.theme.3')
                                        selected
                                    @endif
                                 value="app.theme.3"> {{ trans('labels.White/Lime') }}</option>
                                ...
                                <option @if($result['settings'][81]->value == 'app.theme.9')
                                 ...
                                 <option @if($result['settings'][81]->value == 'app.theme.10')
                                        selected
                                    @endif
                                 value="app.theme.10"> {{ trans('labels.White/Red') }}</option>
                               </select>
                            ...
                            <div class="form-group">
                              <label for="name" class="col-sm-2 col-md-3 control-label">{{ trans('labels.contactUsForm') }}
                              
                              </label>
                              <div class="col-sm-10 col-md-4">
                              <select name="{{$result['settings'][84]->name}}" class="form-control">
                              	<option @if($result['settings'][84]->value == '1')
                                        selected
                                    @endif
                                 value="1"> {{ trans('labels.Show') }}</option>
                              	<option @if($result['settings'][84]->value == '0')
                                        selected
                                    @endif
                                 value="0"> {{ trans('labels.Hide') }}</option>
                                ...
                                <span class="help-block" style="font-weight: normal;font-size: 11px;margin-bottom: 0;margin-top: 0;">{{ trans('labels.contactUsFormText') }}</span>
                              </div>
                            </div>
