      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">{{ trans('labels.ListingAllPages') }} </h3>
            <div class="box-tools pull-right">
            	<a href="{{ URL::to('admin/addwebpage') }}" type="button" class="btn btn-block btn-primary">{{ trans('labels.AddPage') }}</a>
            </div>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
            ...
            <div class="row">
              <div class="col-12">
                ...
                <div class="col-12 text-right">
                	{{$result["pages"]->links('vendor.pagination.default')}}
                </div>
              </div>
