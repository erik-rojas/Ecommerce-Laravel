<head>
  ...
  <!-- jvectormap -->
  <link href="{!! asset('resources/views/admin/plugins/jvectormap/jquery-jvectormap-2.0.3.css') !!}" media="all" rel="stylesheet" type="text/css" />
  <!-- Theme style -->
  <link href="{!! asset('resources/views/admin/dist/css/AdminLTE.css') !!}" media="all" rel="stylesheet" type="text/css" />
