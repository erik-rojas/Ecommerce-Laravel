...
<script src="{!! asset('resources/views/admin/bootstrap/js/bootstrap.js') !!}"></script>
<script src="{!! asset('resources/views/admin/plugins/select2/select2.full.min.js') !!}"></script>

<!-- InputMask -->
<script src="{!! asset('resources/views/admin/plugins/input-mask/inputmask.js') !!}"></script>
<script src="{!! asset('resources/views/admin/plugins/input-mask/inputmask.date.extensions.js') !!}"></script>
<script src="{!! asset('resources/views/admin/plugins/input-mask/inputmask.numeric.extensions.js') !!}"></script>
<script src="{!! asset('resources/views/admin/plugins/input-mask/inputmask.extensions.js') !!}"></script>
...
<!-- AdminLTE App -->
<script src="{!! asset('resources/views/admin/dist/js/app.js') !!}"></script>
...
<script src="{!! asset('resources/views/admin/plugins/jvectormap/jquery-jvectormap-2.0.3.min.js') !!}"></script>
