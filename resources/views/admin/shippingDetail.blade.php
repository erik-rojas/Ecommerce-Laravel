...
<div class="content-wrapper"> 
  ...
  <section class="content-header">
    <h1>@if($result['shppingMethods'][0]->table_name=='free_shipping')
      {{ trans('labels.FreeShipping') }} @elseif($result['shppingMethods'][0]->table_name=='local_pickup') {{ trans('labels.LocalPickup') }} @endif  <small>@if($result['shppingMethods'][0]->table_name=='free_shipping')
      {{ trans('labels.FreeShipping') }}... @elseif($result['shppingMethods'][0]->table_name=='local_pickup') {{ trans('labels.LocalPickup') }}... @endif</small> </h1>
    <ol class="breadcrumb">
      <li><a href="{{ URL::to('admin/shippingmethods')}}"><i class="fa fa-bars"></i> {{ trans('labels.Shipping Method') }}</a></li>
      <li class="active">@if($result['shppingMethods'][0]->table_name=='free_shipping')
      {{ trans('labels.FreeShipping') }} @elseif($result['shppingMethods'][0]->table_name=='local_pickup') {{ trans('labels.LocalPickup') }} @endif</li>
    </ol>
  </section>
      ...
      <div class="col-md-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">@if($result['shppingMethods'][0]->table_name=='free_shipping')
      {{ trans('labels.FreeShipping') }} @elseif($result['shppingMethods'][0]->table_name=='local_pickup') {{ trans('labels.LocalPickup') }} @endif </h3>
          </div>
